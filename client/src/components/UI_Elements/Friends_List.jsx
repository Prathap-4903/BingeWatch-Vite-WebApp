...
const Friends_List = (props) => {
  ...
  return (
    <>
      <div className='w-[70px] h-[75px] bg-emerald-300 flex flex-col justify-center items-center font-geist-medium gap-2'>
        ...
        <p className='text-white text-[12px]'>Peter_Parker_4903</p>
      </div>
    </>
  )
}
